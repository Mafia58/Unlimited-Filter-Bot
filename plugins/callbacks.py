...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("How to Deploy? go and ask him", url="https://t.me/akalankanime"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Moveis Channel", url="https://t.me/reviewhmofficial"),
                    InlineKeyboardButton("Moveis Group", url="https://t.me/HMOFFICIALMovies")
                ]
            ]
        )
